<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            @foreach ($prizesGbCate['大事件獎'] as $key => $prize)
                <details close>
                            ...
                            <tbody>
                                @if ($prize->amount <= 1)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="py-4 px-6">
                                            {{ $bigNewsWinners[$key]->name }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $bigNewsWinners[$key]->phone }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $bigNewsWinners[$key]->email }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $bigNewsWinners[$key]->vote_id }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $bigNewsWinners[$key]->created_at }}
                                        </td>
                                    </tr>
                                @else
                                    @foreach ($bigNewsWinners[$key] as $k => $winner)
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            <th scope="row"
                                                class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                {{ $k + 1 }}
