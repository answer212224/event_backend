            ...
            <div class="w-full max-w-6xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200 mt-2">
                <header class="px-5 py-4 border-b border-gray-100">
                    ...
                    <div class="flex justify-between">
                        ...
                        <form method="POST" action="{{ route('pets.export') }}">
                            @csrf
                            <x-button>
                        ...
                        <div>
                            <a class="text-indigo-400" href="{{ route('pets.posts') }}">所有投稿</a>
                        </div>
                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                @foreach ($members as $member)
                                    <tr>
                                        ...
                                        <td class="p-2 whitespace-nowrap">
                                            <div class="text-left">
                                                <a href="{{ route('pets.show', ['member' => $member]) }}"><i
                                        ...
                                        <td class="p-2 whitespace-nowrap">
                                            <div class="text-left;">
                                                <a href="{{ route('pets.vote', ['member' => $member]) }}"
                                                    class="text-blue-600 ">
                                                    {{ $member->votes_count }}
                                                </a>
                                            </div>
